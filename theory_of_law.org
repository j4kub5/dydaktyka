...
2. Course credit conditions:
   ...
   - grading scale:
     ...
     + >= 85% — 4,5
     + >= 95% — 5,0
3. Make sure you know how to use MS Teams. MS Teams is available at: https://teams.microsoft.com (instructions: https://support.microsoft.com/en-us/teams).  Access code to our team is:
   + =wckxmk1=
4. IMPORTANT:
