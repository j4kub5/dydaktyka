** Wnioskowania niededukcyjne (uprawdopodabniające, zawodne)
*Rozdział w podręczniku:* 15
...
Z tego, że wiem, że ulica jest mokra (p) oraz wiem, że jeżeli pada deszcz to ulica jest mokra (q \rarr p) wnioskuję, że padał deszcz (q).
...
- Indukcja zupełna i niezupełna.
  Przykład indukcji zupełnej:
  - S_1 jest P,
  - S_2 jest P,
  - S_3 jest P,
  - S_4 jest P,
  - a zatem każde S jest P.
